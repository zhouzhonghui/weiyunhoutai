...
(function () {
    ...
    window.UMEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:"/wybb-fastplus/sys/oss/upload?token=" + localStorage.getItem("token")             //图片上传提交地址
        ,imagePath:"https://shinechain.oss-cn-beijing.aliyuncs.com/data/{file}"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
