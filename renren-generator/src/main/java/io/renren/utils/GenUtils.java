...
//        templates.add("template/elementui/index.js.vm");
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        map.put("moduleName", tableEntity.getTableName().replaceAll("_",""));
        ...
        for (String template : templates) {
            ...
            try {
                //添加到zip
                zip.putNextEntry(new ZipEntry(getFileName(template, tableEntity.getClassName(), config.getString("package" ), map.get("moduleName").toString())));
